                  ...
                  <div className="row g-0">
                        ...
                        {cart.map((item) => (
                          <div className="row mb-4 d-flex justify-content-between align-items-center">
                            <div className="col-md-2 col-lg-2 col-xl-2">
                              <img src={item.productImage} className="img-fluid rounded-3" alt="Cotton T-shirt" />
                            </div>
                            ...
                            <div className="col-md-3 col-lg-3 col-xl-2 d-flex">
                              ...
                              <input
                                id="form1" min="0" name="quantity"  value={item.productQuantity}  type="number" className="form-control form-control-sm" />
                              <button
                                className="btn btn-link px-2" onClick={() => handleQuantityIncrease(item.productId)}>
                            ...
                            <div className="col-md-1 col-lg-1 col-xl-1 text-end">
                              <button className="btn" onClick={() => handleRemoveItem(item.productId)}> <i className="fas fa-times"></i>
                              </button>
                            </div>
                          </div>
                        ))}
                    ...
                    <div className="col-lg-4 bg-grey">
                      <div className="p-5">
                        ...
                        <input
                          type="text" className="form-control m-0 p-0" onChange={(e) => setShipingAddress(e.target.value)}  />
